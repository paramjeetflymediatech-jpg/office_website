...
export const SOCIAL_LINKS = [
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/flymedia.technology/",
    color: "#ffffff",
...
export const MEGA_MENU_DATA = {
  ...
  "Industries We Serve": {
    ...
    links: [
      ...
      { name: "Gastric Bypass Surgery", href: "/bariatric-gastric-bypass-surgery-marketing-services", icon: "/dropdown-icons/r02.webp" },
...
export const CANADA_MEGA_MENU_DATA = {
  "Services": {
    ...
    links: [
      ...
      { name: "Digital Marketing Winnipeg", href: "/canada/best-digital-marketing-agency-in-winnipeg", icon: "/dropdown-icons/digital-consultancy-icon.webp" },
      { name: "Digital Marketing Calgary", href: "/canada/best-digital-marketing-agency-in-calgary", icon: "/dropdown-icons/digital-consultancy-icon.webp" },
      { name: "Digital Marketing Ottawa", href: "/canada/best-digital-marketing-agency-in-ottawa", icon: "/dropdown-icons/digital-consultancy-icon.webp" },
      { name: "Digital Marketing Quebec City", href: "/canada/best-digital-marketing-agency-in-quebec-city", icon: "/dropdown-icons/digital-consultancy-icon.webp" },
