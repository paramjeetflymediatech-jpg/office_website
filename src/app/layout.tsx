...
export default async function RootLayout({
  ...
  let region = "global";
  if (pathname.startsWith("/canada") || pathname.includes("/canada/")) {
    region = "canada";
  } else if (pathname.startsWith("/australia") || pathname.includes("/australia/")) {
    region = "australia";
  }

  const config = await getSEOConfig(region);
