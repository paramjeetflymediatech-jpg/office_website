                  ...
                  <article key={post.id} className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden group flex flex-col hover:shadow-md transition-shadow">
                    ...
                    <div className="p-6 flex flex-col flex-grow">
                      ...
                      <div className="mt-auto">
                        <Link href={`/australia/blog/${post.slug}`} className="text-[#FA7E09] font-bold text-sm uppercase tracking-wide flex items-center gap-1 hover:text-black transition-colors mb-6">
