...
const PPCHeroSection = () => (
  <div className=" bg-[#F1F1F1]">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="flex flex-col-reverse lg:flex-row items-center gap-16 py-12 lg:py-20">
...
const PPCWhyChooseUsSection = () => {
  const cards = [
    {
      title: "Engaging Brand Building",
      desc: "Cater the most engaging and strategic marketing funnels to help you establish a distinctive identity in your market.",
      icon: <Target className="w-6 h-6 text-[#ff9900]" />
    },
    {
      title: "Tried & Tested Optimization",
      desc: "Proven and refined strategies used to optimize business campaigns, driving highly profitable results and client conversions.",
      icon: <Award className="w-6 h-6 text-[#ff9900]" />
    },
    {
      title: "Proven Performance Delivery",
      desc: "Helped thousands of active clients scale their digital reach, target audiences precisely, and generate exceptional performance.",
      icon: <Users className="w-6 h-6 text-[#ff9900]" />
    },
    {
      title: "Tailored Account Management",
      desc: "Build, constantly optimize, and supervise advertising accounts tailored entirely around your unique business goals and sizes.",
      icon: <TrendingUp className="w-6 h-6 text-[#ff9900]" />
    },
    {
      title: "Seamless ROI Improvements",
      desc: "Pinpoint loops in the customer's path from Search to Purchase. We resolve bottlenecks to drastically boost your Return on Investment.",
      icon: <Search className="w-6 h-6 text-[#ff9900]" />
    }
  ];
    ...
    <div className="py-20 bg-[#F1F1F1]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <span className="text-xs font-bold uppercase tracking-widest text-[#ff9900]">Why Choose Flymedia</span>
          <h2 className="text-3xl md:text-4xl font-serif font-bold text-black leading-tight">
            Stop Wasting Time  Budget. Align with certified experts.
          </h2>
          <p className="text-gray-600 text-sm md:text-base leading-relaxed">
            Trying to run a Google Ads campaign on your own can quickly turn into a costly trial-and-error process. Our professional Google AdWords team delivers strategic solutions built under predefined, transparent targets.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {cards.map((card, i) => (
            <div 
              key={i} 
              className="bg-white p-8 rounded-2xl border border-gray-100 shadow-md hover:shadow-xl transition-all duration-300 group hover:-translate-y-1 flex flex-col justify-between"
            >
              <div className="space-y-6">
                <div className="w-12 h-12 bg-[#ff9900]/10 rounded-xl flex items-center justify-center group-hover:bg-[#ff9900] group-hover:text-black transition-colors duration-300">
                  <div className="group-hover:text-black transition-colors duration-300">
                    {React.cloneElement(card.icon, { className: "w-6 h-6 text-[#ff9900] group-hover:text-black transition-colors duration-300" })}
                  </div>
                </div>
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
        ...
        <Link 
          ...
          className="border border-white/20 text-white font-black px-12 py-4 rounded-xl uppercase tracking-wider hover:bg-white hover:text-black transition-all text-sm"
        >
          Call +91-98884-84310
        </Link>
      </div>
